...
class ColorManager {
  static Color primary = "#34E03B".convertToColorFromHex();
  static Color accentGreen = "#153FB4".convertToColorFromHex();
  ...
  // static Color blueGrey1 = "#FCFCFC".convertToColorFromHex();
  static Color blueGrey1 = "#F5F5F5".convertToColorFromHex();
